...
For instance, in the case of Montreal, the course housing need is 57% higher within library walksheds than in the rest of the CMA
...
```{r, echo = FALSE, fig.cap="\\label{figure1} Figure 3: Change in demographic variables between 2006 and 2016", fig.align = 'center', message = FALSE}
figure_6
```
